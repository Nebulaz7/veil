                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <button
                        onClick={copyQRCode}
                        className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-md transition-colors text-sm font-medium"
                      >
                        <Copy className="w-4 h-4" />
